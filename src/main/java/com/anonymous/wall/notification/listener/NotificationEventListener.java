...
public class NotificationEventListener {
    ...
    public void onCommentCreated(CommentCreatedEvent event) {
        if (event.getActorUserId().equals(event.getPostOwnerId())) return;
        try {
            notificationService.createNotification(
                    event.getPostOwnerId(), event.getActorUserId(),
                    "COMMENT", event.getPostId(), null, null);
            ...
            log.error("Failed to process CommentCreatedEvent for postId={}: {}", event.getPostId(), e.getMessage(), e);
        }
    }
    ...
    public void onInternshipCommentCreated(InternshipCommentCreatedEvent event) {
        ...
        try {
            ...
            log.error("Failed to process InternshipCommentCreatedEvent for internshipId={}: {}", event.getInternshipId(), e.getMessage(), e);
        }
    }
    ...
    public void onMarketplaceCommentCreated(MarketplaceCommentCreatedEvent event) {
        ...
        try {
            ...
            log.error("Failed to process MarketplaceCommentCreatedEvent for itemId={}: {}", event.getItemId(), e.getMessage(), e);
        }
    }
    ...
    public void onChatMessageSent(ChatMessageSentEvent event) {
        ...
        try {
            ...
            log.error("Failed to process ChatMessageSentEvent for conversationId={}: {}",
